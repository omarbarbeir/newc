...
import {quests} from '../Football_Pages/Five_Quests'
import { Link } from "react-router-dom";

const Five = () => {

    let [five , setFive] = useState(null);
        ...
        <div className="flex flex-col justify-center items-center py-10">
            {five && (
                <div className="flex flex-col text-right  justify-center items-center relative">
                    <h1 className="flex justify-center bg-white/90 items-center h-[390px] w-[400px] md:w-[480px] md:h-[450px] lg:w-[520px] text-3xl p-3  rounded-md">{five.quest}</h1>
                </div>
            )}
        </div>
